...
Menuitem(2, 0,  "Rules",            "ok",               "", "/rules"),
Menuitem(2, 1,  "Roles",            "user",             "", "/roles"),
Menuitem(2, 2,  "Menus",            "menu-hamburger",   "", "/menus"),
Menuitem(2, 3,  "Routes",           "road",             "", "/routes"),
Menuitem(2, 4,  "Plugins",          "cog",              "", "/plugins"),
Menuitem(3, 0,  "",                 "plus",             "", "/rules/create"),
Menuitem(3, 1,  "",                 "remove",           "", "/rules/<id>/delete"),
Menuitem(3, 2,  "",                 "pencil",           "", "/rules/<id>/update"),
Menuitem(4, 0,  "",                 "plus",             "", "/roles/create"),
Menuitem(4, 1,  "",                 "remove",           "", "/roles/<id>/delete"),
Menuitem(4, 2,  "",                 "pencil",           "", "/roles/<id>/update"),
Menuitem(5, 0,  "",                 "plus",             "", "/menubars/create"),
Menuitem(5, 1,  "",                 "remove",           "", "/menubars/<id>/delete"),
Menuitem(5, 2,  "",                 "pencil",           "", "/menubars/<id>/update"),
