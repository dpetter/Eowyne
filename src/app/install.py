    ...
    def installMenus():
        ...
        items = [
                 ...
                 Menu("/rules/create",      "Neue Regel",
                      "rule",       0, 0, "images/administration/create-24.png"),
                 Menu("/rules/<id>/delete", "",
                      "rule",       1, 0, "images/administration/delete-24.png"),
                 Menu("/rules/<id>/update", "",
                      "rule",       2, 0, "images/administration/update-24.png"),
                 Menu("/roles/create",      "Neue Rolle",
                      "role",       0, 0, "images/administration/create-24.png"),
                 Menu("/roles/<id>/delete", "",
                      "role",       1, 0, "images/administration/delete-24.png"),
                 Menu("/roles/<id>/update", "",
                      "role",       2, 0, "images/administration/update-24.png"),
                 Menu("/menus/create",      "Neuer Menüeintrag",
                      "menu",       0, 0, "images/administration/create-24.png"),
                 Menu("/menus/<id>/delete", "",
                      "menu",       1, 0, "images/administration/delete-24.png"),
                 Menu("/menus/<id>/update", "",
                      "menu",       2, 0, "images/administration/update-24.png"),
                 Menu("/blog/create",     "Neuer Blogeintrag",
                      "blog",       0, 0, "images/administration/create-24.png"),
                 Menu("/blog/(id>/delete", "",
                      "blog",       1, 0, "images/administration/delete-24.png"),
                 Menu("/blog/<id>/update", "",
                      "blog",       2, 0, "images/administration/update-24.png")
                 ]
        for item in items: item.create()
