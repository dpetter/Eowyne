...
from core.shared import db, cache, mailservice, log
...
log.addHandler(handler)  # @UndefinedVariable

log.info("Initialising Flask ...")
# -------------------------------------------------------------------------------- #
app = Flask(__name__,
...
log.info("Setting up mailservice ...")
# -------------------------------------------------------------------------------- #
...
for module in modules:
    ...
    log.info("Importing %s ..." % (module.__name__))
    app.register_blueprint(module.blueprint)

log.info("Making hearts beat ...")
# -------------------------------------------------------------------------------- #
heartbeat_functions = []
